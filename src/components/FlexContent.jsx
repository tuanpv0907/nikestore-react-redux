  ...
  return (
    ...
    >
      <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center md:justify-items-center ">
        ...
        <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-3xl xsm:text-2xl font-bold text-slate-900 filter drop-shadow-lg">
          {title}
        </h1>
      ...
      <div className="flex items-center justify-center max-w-full relative lg:max-w-none w-full">
        <img
          src={img}
          alt={`img/${heading}`}
